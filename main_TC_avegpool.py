...
Output_root = Output_root+ "temporal consistent_avgpool/"
...
Model_infer = model_infer_TC._Model_infer(GPU_mode,num_gpus,Enable_teacher=True,gpu_selection="1",pooling="avg")
# if GPU_mode == True:
#     if num_gpus > 1:
