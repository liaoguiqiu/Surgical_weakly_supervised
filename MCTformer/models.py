...
from MCTformer.vision_transformer import VisionTransformer, _cfg
...
class MCTformerV2(VisionTransformer):
    ...
    def forward(self, x, return_att=False, n_layers=12, attention_type='patchcam'):
        w, h = x.shape[2:]
        ...
        if return_att:
            return x_cls_logits, cams, patch_attn,x_patch_logits
        else:
