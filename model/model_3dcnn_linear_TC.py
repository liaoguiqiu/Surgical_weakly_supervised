...
class _VideoCNN(nn.Module):
    ...
    def __init__(self, inputC=256,base_f=256):
        ...
        #
        base_f1= base_f
        self.blocks.append(block_buider.conv_keep_all(inputC, base_f1,k=(1,1,1), s=(1,1,1), p=(0,0,0), resnet= True,dropout = Drop_out))
        ...
        base_f3 = base_f2
        # # 8*256  - 4*256\
        self.blocks.append(block_buider.conv_keep_all(base_f2, base_f3,k=(1,1,1), s=(1,1,1), p=(0,0, 0),resnet = True,dropout = Drop_out))
        # base_f = base_f  
